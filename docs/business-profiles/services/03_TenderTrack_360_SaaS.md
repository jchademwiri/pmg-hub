...
- Commercialise TenderTrack 360 as a standalone revenue stream for PMG
- Add integrations with eTender Portal and government procurement databases
- Build CSD renewal alert system into the platform
- Offer white-label licensing to other tender consultancy firms
- Scale subscriptions nationally across South Africa
