...
1. **+ R 3 456,25** (Prior Month Collections): Cash collected in June for outstanding invoices issued in April.
   - _Basadipele_: R 2 500,00 (pays off invoice `TES-INV-2026-007`)
   - _DN Armature Winders_: R 956,25 (pays off April invoices)
2. **- R 4 430,00** (Uncollected June Revenue): Value of invoices sent in June that remain unpaid at month-end.
   - _TES-INV-2026-019 (Basadipele)_: R 2 500,00 (outstanding)
   - _TES-INV-2026-018 (DN Armature Winders)_: R 850,00 (outstanding)
   - _TES-INV-2026-020 (Sosha Lam)_: R 1 000,00 (outstanding balance)
   - _TES-INV-2026-017 (Mathange)_: R 80,00 (outstanding balance)
...
- **Trial Balance Equation:**
  ...
  - _Calculation verified: Trial Balance is perfectly in balance with zero discrepancy._
