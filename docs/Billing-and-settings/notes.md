...
- all quotes must have a client
- all items must come from our presaved items
...
/billing/items/*
- remove the toggle for VAT (VAT Applicable)
- any item sent to Archived it will be marked as not active automatically, and when restored it becomes active automatically
