...
| ConfirmDialog _(custom wrapper)_ | `ui/confirm-dialog.tsx` |
| Dialog                           | `ui/dialog.tsx`         |
| DropdownMenu                     | `ui/dropdown-menu.tsx`  |
| EmptyState _(custom)_            | `ui/empty-state.tsx`    |
| Field _(custom)_                 | `ui/field.tsx`          |
| Input                            | `ui/input.tsx`          |
| Label                            | `ui/label.tsx`          |
...
_Generated: May 2026 - PMG Control Center shadcn/ui Audit_
