...
1. The document tables (Invoices, Quotations, Payments) expand to fill the entire horizontal section. This makes room for important columns (e.g., _Division_, _Email Delivery Status_, _Balance_, _Created By_) that are currently hidden.
