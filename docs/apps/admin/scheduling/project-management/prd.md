...
_Note: MVP targets a single-user workflow. Permission level is implicit (only the logged-in admin user can access)._

## Core User Stories

### US-01: Capture a tender

> _As Jacob, I want to add a new tender to my schedule so I know I have work coming up._
...
> _As Jacob, I want to see a "current workload" view that shows what I am working on now and what is coming next._
...
> _As Jacob, I want to move a tender through statuses (planned → in_progress → completed → submitted) so I can track where I am._
...
> _As Jacob, I want visual indicators that show when a tender is at risk of missing its closing date._
...
> _As Jacob, I want to mark a tender as Won, Lost, or Pending after submission so I can keep a record._
...
> _As Jacob, I want to record how many days a tender actually took so I can improve my future estimates._
...
> _As Jacob, I want a separate field for blockers so I can track what's holding up progress._
...
> _As Jacob, I want to cancel or remove a tender from my schedule if it is no longer relevant._
...
> _As Jacob, I want to update any schedule field (effort, dates, notes, status) if things change._
