...
1. **The "Two-Month Lookahead" (e.g., Sent on the 25th of the month)**
   - _Example:_ On June 25th, the system scans for documents expiring in July and August.
   - _Message:_ "Heads up! You have compliance documents expiring in the next 60 days. Taking action now ensures your tender readiness is not interrupted."
2. **The "Current Month Warning" (e.g., Sent on the 10th of the month)**
   - _Example:_ On July 10th, sends a reminder strictly for documents expiring _this month_.
   - _Message:_ "Action Required: The following documents expire this month."
3. **14-Day Warning**
   - _Message:_ "Urgent: You have compliance documents expiring in exactly 14 days."
4. **7-Day Final Warning**
   - _Message:_ "Critical: Your compliance documents will expire in 7 days."
5. **The "Expired Alert" (Sent on the day after expiry)**
   - _Message:_ "Your compliance document has expired. Please update it in the portal to maintain compliance."
...
4. **As an Admin**, I want a dashboard view of _all_ clients with upcoming expirations so I can proactively offer "Compliance Renewal" services as an upsell.
