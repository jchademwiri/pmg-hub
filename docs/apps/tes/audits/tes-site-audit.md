...
- **Impact:**
  ...
  3. If _one_ malicious user or client submits the lead enquiry form 5 times within a minute, **every single user globally** is instantly rate-limited with a `429 Too Many Requests` response.
