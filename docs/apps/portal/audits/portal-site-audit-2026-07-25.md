...
- **Strengths**:
  - Displays 4 key KPI cards: _Outstanding Balance_, _Paid to Date_, _Total Invoiced_, and _Pending Quotes_.
...
- **Strengths**:
  - Full status filtering (_All_, _Issued_, _Paid_, _Overdue_).
...
- **Strengths**:
  ...
  - **Ageing Summary**: Calculates _Current_, _30 Days_, _60 Days_, and _90 Days+_ overdue buckets in real-time.
...
- **Strengths**:
  - Full document upload workflow with expiry date warnings and status tracking (_Valid_, _Expiring Soon_, _Expired_).
