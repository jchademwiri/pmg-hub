...
_Copy and paste this at the start of your next conversation with Claude_
...
## BRAND COLOURS (from playhousemedia.net)
...
| #   | Brand Name                | Domain                               | Service                                | Status             |
| --- | ------------------------- | ------------------------------------ | -------------------------------------- | ------------------ |
| 1   | Apex Web Solutions        | apexwebsolutions.co.za _(LIVE)_      | Web design & development               | **Active revenue** |
| 2   | Playhouse Creative Studio | playhousecreative.co.za _(register)_ | Graphic design & marketing             | Launching          |
| 3   | TenderCore Solutions      | tendercore.co.za _(register)_        | Tendering compliance & bid preparation | **Active revenue** |
| 4   | BizStart Hub              | bizstarthub.co.za _(register)_       | Company registrations & CIPC           | Formalising        |
...
Jacob builds with **Next.js, TypeScript, and shadcn/ui**. All division websites will use this stack, deployed on Vercel.
...
- PMG tagline: _"Building Businesses. One Service at a Time."_
...
| Business-in-a-Box (CIPC + CSD + BEE + Logo + 1-page site) | R4,500    |
...
| Service                       | Price            |
| ----------------------------- | ---------------- |
| Logo design                   | R1,800–R3,500    |
| Full Brand Identity           | R4,500–R8,000    |
| Company Profile design        | R2,500–R4,500    |
| Monthly social media retainer | R2,500–R4,500/mo |

### Revenue Targets

| Period                 | Target   |
| ---------------------- | -------- |
| Year 1 Group Total     | R324,000 |
| Year 1 Monthly Average | R27,000  |
| Year 2 Group Total     | R624,000 |
...
- [ ] Register playhousemediagroup.co.za _(urgent)_
...
- [ ] Terms sheet for compliance services
- [ ] Quote/invoice template per division
- [ ] Set up Wave Accounting or Xero
- [ ] Set up ClickUp (one board per division)
- [ ] Set up WhatsApp Business catalogue and auto-reply

---

_Document last updated: March 2025 | Version 3.0_
