...
- [ ] 1. DB schema — create snapshots table
...
- [ ] 2. Query helpers — add snapshot queries to queries.ts
  - [ ] 2.1 Add `SnapshotRow` type and three query helpers to `packages/db/src/queries.ts`
...
- [ ] 3. Checkpoint — ensure DB layer compiles and types resolve
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Server Action — implement closeMonth
...
- [ ] 5. Dashboard integration — CloseMonthButton + DashboardShell + page.tsx
  - [ ] 5.1 Create `apps/admin/src/components/dashboard/close-month-button.tsx`
  ...
  - [ ] 5.2 Modify `apps/admin/src/app/(admin)/dashboard/page.tsx`
  ...
  - [ ] 5.3 Modify `apps/admin/src/components/dashboard/dashboard-shell.tsx`
...
- [ ] 6. Checkpoint — ensure dashboard compiles and Close Month button renders
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Snapshots page — new route + sidebar nav item
  - [ ] 7.1 Create `apps/admin/src/app/(admin)/snapshots/page.tsx`
  ...
  - [ ] 7.2 Modify `apps/admin/src/components/layout/app-sidebar.tsx`
...
- [ ] 8. Seed update — add snapshot rows for past months
...
- [ ] 9. Checkpoint — run `bun db:seed` and verify clean reset + reseed
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. Tests — write full test suite
  - [ ] 10.1 Create `apps/admin/src/__tests__/snapshots.test.ts`
