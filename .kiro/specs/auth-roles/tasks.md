...
- [x] 1. Add `invitations` table schema and run migration
...
- [x] 2. Configure Better Auth server and browser client
  - [x] 2.1 Create `apps/admin/src/lib/auth.ts`
...
- [x] 4. Update `proxy.ts` with session guard and rate limiter
  ...
  - [x] 4.1 Write property tests for proxy (P4, P5, P6, P11)
...
- [x] 5. Update admin layout with session fetch and user prop
...
- [x] 6. Update `AppSidebar` with user display and sign-out
...
- [x] 7. Replace login page with magic link form
...
- [x] 8. Implement user management Server Actions
...
- [x] 10. Implement invitation property tests
  - [x] 10.1 Write property tests for invitation flow (P1, P2, P3)
...
- [x] 11. Build user management UI components
  - [x] 11.1 Create `apps/admin/src/components/users/user-table.tsx`
...
- [x] 12. Build user management pages
