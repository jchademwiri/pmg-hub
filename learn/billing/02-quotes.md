...
> A quote is a price estimate sent before the client commits to the work.

## When To Use A Quote

Use a quote when:

- The client asked for pricing
- Work has not been approved yet
- You want the client to accept before invoicing
...
1. Go to Billing -> Quotes.
2. Create a new quote.
3. Select the client and division.
4. Add line items.
5. Save as draft if still checking.
6. Mark as sent when it goes to the client.
7. If accepted, create the invoice.
