# 3. Expenses And Categories

> Expenses are business costs. Categories explain what kind of costs they are.

## When To Record An Expense

Record an expense when the business spends money, for example:
...
2. Add the expense date.
3. Enter the amount.
4. Choose the correct division.
5. Choose the best category.
