  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      >
        ...
        <Body
          className="m-0 bg-[#F6F8FA] py-[40px] font-sans"
        ...
        >
          ...
          >
            ...
            {/* Main Content */}
            <Section className="mb-[24px]">{children}</Section>
            ...
            <Section className="mt-[32px] border-none border-t border-solid border-[#E2E8F0] pt-[24px] text-center">
              ...
              <Text className="m-0 mt-[20px] text-[12px] text-[#64748B] leading-[18px]">
                This email was sent on behalf of <strong>{companyName}</strong>. If you have any
                questions or require assistance, please reply directly to this message.
              </Text>
