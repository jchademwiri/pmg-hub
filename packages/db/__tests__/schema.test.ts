...
describe('schema structure', () => {
  describe('barrel index exports', () => {
    ...
    it('exports divisions table', () => {
      expect(schema.divisions).toBeDefined();
    });
    it('exports clients table', () => {
      expect(schema.clients).toBeDefined();
    });
    it('exports income table', () => {
      expect(schema.income).toBeDefined();
    });
    it('exports expenses table', () => {
      expect(schema.expenses).toBeDefined();
    });
    it('exports leads table', () => {
      expect(schema.leads).toBeDefined();
    });

    // Enums exported
    it('exports leadStatusEnum', () => {
      expect(schema.leadStatusEnum).toBeDefined();
    });
    it('exports awsPackageTypeEnum', () => {
      expect(schema.awsPackageTypeEnum).toBeDefined();
    });

    // Relations exported
    it('exports divisionsRelations', () => {
      expect(schema.divisionsRelations).toBeDefined();
    });
    it('exports clientsRelations', () => {
      expect(schema.clientsRelations).toBeDefined();
    });
    it('exports incomeRelations', () => {
      expect(schema.incomeRelations).toBeDefined();
    });
    it('exports expensesRelations', () => {
      expect(schema.expensesRelations).toBeDefined();
    });
    it('exports leadsRelations', () => {
