...
describe('Declarative Accounting PDF Documents', () => {
  ...
  it('renders Balance Sheet into a valid PDF', async () => {
    ...
    const sampleBalanceSheet = {
      ...
      equity: [{ accountCode: '3000', accountName: 'Share Capital', amount: 100 }],
      netIncome: 499900,
      totalEquity: 500000,
  ...
  it('renders 6-page Annual Financial Statements (AFS) into a valid multi-page PDF', async () => {
    ...
    const sampleAfs = {
      ...
      directorsReport: {
        principalActivities:
          'Playhouse Media Group provides full-service digital consulting, web design, and systems engineering.',
        businessActivities: {
      ...
      statementOfPosition: {
        ...
        totalAssets: { current: 850000, prior: 520000 },
        liabilities: [{ accountName: 'Trade and other payables', amount: 120000 }],
