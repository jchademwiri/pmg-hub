            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <Table>
                <TableHeader style={{ backgroundColor: '#f8fafc' }}>
                  <TableRow>
                    <TableHead
                      style={{ width: '20%', fontSize: 7.5, fontWeight: 700, color: '#64748b' }}
                    >
                      ACCOUNT CODE
                    </TableHead>
                    <TableHead
                      style={{ width: '65%', fontSize: 7.5, fontWeight: 700, color: '#64748b' }}
                    >
                      ACCOUNT NAME
                    </TableHead>
                    <TableHead
                ...
                <TableBody>
                  {accounts.map((account) => (
                    <TableRow key={`acc-${account.id}`}>
                      <TableCell
                        style={{ width: '20%', fontSize: 8, fontWeight: 600, color: '#0f172a' }}
                      >
                        {account.code}
                      </TableCell>
