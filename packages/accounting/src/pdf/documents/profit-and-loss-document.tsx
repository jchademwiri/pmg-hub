          ...
          <TableBody>
            {result.revenue.length === 0 ? (
              <TableRow>
                ...
                <TableCell
                  style={{ width: '25%', textAlign: 'right', color: '#a1a1aa', fontSize: 8.5 }}
                >
                  {formatZAR(0)}
                </TableCell>
              </TableRow>
      ...
      <KeepTogether>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span
              style={{ fontSize: 11, fontWeight: 700, color: isProfit ? '#166534' : '#991b1b' }}
            >
          ...
          <div style={{ marginTop: 10 }}>
            ...
            <Table>
              <TableHeader style={{ backgroundColor: '#f8fafc' }}>
                <TableRow>
                  <TableHead
                    style={{ width: '28%', fontSize: 7.5, fontWeight: 700, color: '#64748b' }}
                  >
                    DIVISION
                  </TableHead>
                  <TableHead
              ...
              <TableBody>
                {byDivision.map((div, idx) => (
                  <TableRow key={`div-${div.divisionId || idx}`}>
                    <TableCell
                      style={{ width: '28%', fontSize: 7.5, fontWeight: 600, color: '#18181b' }}
                    >
                      {div.divisionName}
                    </TableCell>
                    <TableCell
                    ...
                    <TableCell
                      style={{
                        ...
                        fontSize: 7.5,
                        fontVariantNumeric: 'tabular-nums',
                        color: div.totalOutstandingAr > 0 ? '#dc2626' : '#71717a',
                      }}
                    >
  ...
  return (
    ...
    >
      <Table>
        <TableHeader style={{ backgroundColor: '#f8fafc' }}>
          <TableRow>
            <TableHead style={{ width: '24%', fontSize: 7.5, fontWeight: 700, color: '#64748b' }}>
              DIVISION
            </TableHead>
            <TableHead
              style={{
            ...
            <TableRow key={`div-perf-${row.divisionId || idx}`}>
              ...
              <TableCell
                style={{
                  ...
                  fontSize: 8,
                  fontVariantNumeric: 'tabular-nums',
                  color: row.totalOutstandingAr > 0 ? '#dc2626' : '#71717a',
                }}
              >
