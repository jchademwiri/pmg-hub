    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '45%' }}>
          ...
          {org.email && (
            <span style={{ fontSize: 7.5, color: theme.colors.mutedForeground }}>{org.email}</span>
          )}
          {org.phone && (
            <span style={{ fontSize: 7.5, color: theme.colors.mutedForeground }}>{org.phone}</span>
          )}
          {org.website && (
            <span style={{ fontSize: 7.5, color: theme.colors.mutedForeground }}>
              {org.website}
      ...
      <div
        style={{ width: '100%', height: 1, backgroundColor: theme.colors.border, marginTop: 14 }}
      />
    </div>
  );
}
