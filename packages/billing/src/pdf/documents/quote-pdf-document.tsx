        ...
        <Table variant="compact" style={{ marginBottom: theme.spacing.sectionGap }}>
          <TableHeader>
            <TableRow header>
              ...
              <TableCell header align="center" width="12%">
                Qty
              </TableCell>
              <TableCell header align="right" width="18%">
                Unit Price
              </TableCell>
              <TableCell header align="right" width="18%">
                Amount
            ...
            {!data.items || data.items.length === 0 ? (
              <TableRow>
                <TableCell
                  colSpan={4}
                  align="center"
                  style={{ color: theme.colors.mutedForeground, padding: 12 }}
                >
                  No items listed
                </TableCell>
              </TableRow>
              ...
              data.items.map((item, idx) => (
                <TableRow key={idx} striped={idx % 2 === 1}>
                  ...
                  <TableCell align="center" width="12%" tabular>
                    {item.qty}
                  </TableCell>
                  <TableCell align="right" width="18%" tabular>
                    {formatZAR(item.unitPrice)}
                  </TableCell>
                  <TableCell align="right" width="18%" bold tabular>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', width: '50%' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <span
                  style={{ fontSize: 7.5, color: theme.colors.mutedForeground, lineHeight: 1.45 }}
                >
                  Quotation valid for 30 days. 50% deposit required prior to development
                  commencement. Final website/project deployment upon receipt of full balance.
                </span>
              </div>
              ...
              {data.notes && (
                <div style={{ display: 'flex', flexDirection: 'column', marginTop: 8 }}>
                  ...
                  <span
                    style={{ fontSize: 7.5, color: theme.colors.mutedForeground, lineHeight: 1.4 }}
                  >
                    {data.notes}
                  </span>
                </div>
              ...
              <KeyValue
                ...
                items={[
                  ...
                  ...(data.totals.discount
                    ? [{ key: 'Discount', value: `-${formatZAR(data.totals.discount)}` }]
                    : []),
                  ...(vat > 0
                    ? [{ key: 'VAT (15%)', value: formatZAR(vat) }]
                    : [{ key: 'VAT', value: 'Exempt / R 0.00' }]),
                  {
                    key: 'Total Estimate',
