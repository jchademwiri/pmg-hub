...
import { getDb, invoices, quotations, paymentAllocations } from '@pmg/db';
import { eq, and, ne, desc, inArray } from 'drizzle-orm';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { FileText, FileSpreadsheet, Landmark, PiggyBank, ArrowUpRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Welcome back! Here is a summary of your billing relationship with PMG.
        </p>
      </div>
