    ...
    <div className="flex min-h-screen bg-[#080c14] text-foreground font-sans selection:bg-blue-500/30">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-white/5 bg-[#0a0f1d]/95 backdrop-blur-md pb-safe">
        <div className="flex h-16 items-center justify-around px-2">
          ...
          <button onClick={() => setIsMobileOpen(true)} className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${isMobileOpen ? 'text-blue-400' : 'text-muted-foreground hover:text-white'}`}>
