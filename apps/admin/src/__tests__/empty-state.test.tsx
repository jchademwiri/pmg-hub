...
describe('EmptyState', () => {
  it('renders the message and CTA link when both ctaLabel and ctaHref are provided', () => {
    render(
      <EmptyState message="No income records found." ctaLabel="Add Income" ctaHref="/income/new" />,
    );
  ...
  it('renders a filter-specific message when filtered=true', () => {
    render(<EmptyState message="No results match your current filter." filtered={true} />);
