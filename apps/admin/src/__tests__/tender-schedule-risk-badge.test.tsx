/**
 * Component tests for TenderRiskBadge risk calculation logic.
 *
...
describe('TenderRiskBadge — time-based risk', () => {
  ...
  it('shows "Overdue" when closing date is past', async () => {
    ...
    render(<TenderRiskBadge tender={makeTender({ status: 'planned', closingDate: closing })} />)
