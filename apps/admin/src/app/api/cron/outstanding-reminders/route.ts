...
export async function GET(req: Request) {
  ...
  try {
    // 2. Execute the 3-stage lifecycle statement / reminder dispatcher (Option B):
    // - 26th of Month: Retainer Monthly Statements (isRetainer = true, balance > 0)
    // - Last Day of Month: Month-End Payment Due Courtesy Notice (balance > 0)
    // - 8th of Month: Overdue-Only Reminders for prior month debt (balance > 0)
