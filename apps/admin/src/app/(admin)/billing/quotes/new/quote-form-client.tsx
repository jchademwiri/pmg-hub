...
import { BillingLineItemsForm, type LineItemFormRow } from '@/components/billing/billing-line-items-form';
...
export function QuoteFormClient({ divisions, clients }: QuoteFormClientProps) {
