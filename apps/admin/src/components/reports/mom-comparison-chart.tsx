...
export function MoMComparisonChart({
  data,
  currentMonthLabel,
  previousMonthLabel,
  onBarClick,
        ...
        {data.length === 0 ? (
          ...
          <ChartContainer config={config}>
            <BarChart data={data}>
              ...
              <ChartTooltip
                content={
                  <ChartTooltipContent indicator="dot" formatter={(v) => formatZAR(Number(v))} />
                }
              />
              ...
              <Bar
                ...
                onClick={
                  onBarClick
                    ? (_data, index) => onBarClick(data[index]?.metric ?? '', 'current')
                    : undefined
                }
              ...
              <Bar
                ...
                onClick={
                  onBarClick
                    ? (_data, index) => onBarClick(data[index]?.metric ?? '', 'previous')
                    : undefined
                }
                className={onBarClick ? 'cursor-pointer' : undefined}
              >
