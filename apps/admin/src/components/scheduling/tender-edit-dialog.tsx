...
export function TenderEditDialog({
  ...
  const [editTenderReference, setEditTenderReference] = React.useState(tender.tenderReference);
  ...
  React.useEffect(() => {
    if (open) {
      ...
      getTenderChecklistAction(tender.id).then((res) => {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      fd.append('tenderReference', editTenderReference);
